            ...
            <div class="card">
                <div class="card-body">
                    <div class="mb-3">
                        ...
                        <input type="hidden" name="edit_job_id" value="{{$job_edit->id}}" class="form-control" id="project-title-input" placeholder="Enter project title">
                    </div>
                        ...
                        <div class="col-lg-12">
                            <div>
                                ...
                                <select class="form-control" name="job_status">
                                    ...
                                    <option value="2" {{$job_edit->job_status == 2 ?'selected':''}}>Approved</option>
                                    <option value="3" {{$job_edit->job_status == 3 ?'selected':''}}>Pushed</option>
                                    <option value="4" {{$job_edit->job_status == 4 ?'selected':''}}>Rejected</option>
                                </select>
                            </div>
                        </div>
                        <br>
