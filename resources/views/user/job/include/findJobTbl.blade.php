                    ...
                    <div class="d-flex flex-column h-100">
                        <div class="d-flex">
                            <div class="flex-grow-1">
                                <p class="text-muted mb-4">Created Date : {{\Carbon\Carbon::parse($job->created_at)->diffForHumans()}}</p>
                            </div>
                        ...
                        <div class="mt-auto">
                            ...
                            <div class="progress progress-sm animated-progress">
                                ...
                                <div class="progress-bar bg-success" role="progressbar"
                                     aria-valuenow="{{$count_workder}}" aria-valuemin="0" aria-valuemax="{{$job->worker_need}}"
                                     style="width: {{$percen}}%;">
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="d-flex align-items-center">
                        <div class="flex-shrink-0">
                            <div class="text-muted">
                                <?php
                                $user_name = \App\Models\User::select('id','name')->where('id',$job->user_id)->first();
                                ?>
