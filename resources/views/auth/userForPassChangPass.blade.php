                            ...
                            <div class="p-2 mt-4">
                                <form action="{{route('forgot.password.change.pass.save')}}" method="post">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="password" name="npass" class="form-control" id="username" placeholder="Enter new password" required>
                                        <input type="hidden" name="vlink" value="{{$link}}" required>
                                    </div>

                                    <div class="mb-3">
                                        <label for="username" class="form-label">Confirm Password</label>
                                        <input type="password" name="cpass" class="form-control" id="username" placeholder="Enter confirm password" required>
                                    </div>
