                ...
                <div class="col-md-8 col-lg-6 col-xl-5">
                    <div class="card mt-4">
                        ...
                        <div class="card-body p-4">
                            ...
                            <div class="p-2 mt-4">
                                <form action="{{route('forgot.password.verify.code.submit')}}" method="post">
                                    @csrf
                                    <div class="mb-3">
                                        <label for="username" class="form-label">Code</label>
                                        <input type="text" name="code" class="form-control" id="username" placeholder="Enter Code" required>
                                    </div>
