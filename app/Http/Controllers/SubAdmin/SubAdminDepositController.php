...
class SubAdminDepositController extends Controller
{
    ...
    {
        return view('subadmin.deposit.allDeposit');
    }
    ...
    {
        return view('subadmin.deposit.pendingDeposit');
    }
    ...
    {
        return view('subadmin.deposit.approvedDeposit');
    }
    ...
    {
        return view('subadmin.deposit.rejectedDeposit');
    }
